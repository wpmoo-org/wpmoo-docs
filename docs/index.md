...
hero:
  name: "WPMoo Toolkit"
  text: "A calmer Odoo development workflow."
  tagline: Repeatable Odoo dev environments, clean addon repos, and one cockpit for daily module work.
  image:
    src: /assets/wpmoo-logo.webp
    alt: WPMoo Toolkit logo
  actions:
    - theme: brand
      text: Start in 3 commands
      link: "#quick-start"
    - theme: alt
      text: Read the docs
...
<p align="center">
  <img src="/assets/wpmoo-flow.png" alt="WPMoo Toolkit Odoo workflow" width="860" />
</p>
...
- [Module Workflow](/guide/module-workflow)
- [Quality Gates](/guide/quality-gates)
- [Command Reference](/reference/commands)
- [Generated Environments](/reference/generated-environments)
- [Recovery Workflows](/operations/recovery)
- [Troubleshooting](/operations/troubleshooting)

Legacy aliases are documented in the [command reference](/reference/commands).
...
It is independent from Odoo S.A. and is not affiliated with, endorsed by, or
sponsored by Odoo S.A.
